      ...
      <div className="wrapper-group">
        <div className="info-group">
          ...
          <select
            ...
            id="rented"
            defaultValue={0}
            // value={props.isRented}
            onChange={props.handleIsRented}
          >
        ...
        <div className="info-group">
          ...
          <div className="list-appliances">
            <input
              ...
              id="garage"
            />
            <label className="label-addInfo" htmlFor="garage">
              Garage
            </label>
            <input
              className="input-addInfo"
              ...
              id="garden"
            />
            <label className="label-addInfo" htmlFor="garden">
              Garden
            </label>
            <input
              className="input-addInfo"
              ...
              id="carSpace"
            />
            <label className="label-addInfo" htmlFor="carSpace">
              Car Park spaces
            </label>
            <input
              className="input-addInfo"
              ...
              id="patio"
            />
            <label className="label-addInfo" htmlFor="patio">
              Patio
            </label>
          </div>
        </div>
